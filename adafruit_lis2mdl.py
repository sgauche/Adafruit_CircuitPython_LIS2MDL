...
class Adafruit_LIS2MDL:  # pylint: disable=too-many-instance-attributes
    """Base LIS2MDL object. Use :class:`Adafruit_LIS2MDL_I2C` or :class:`Adafruit_LIS2MDL_SPI`
    ...
    def __init__(self):
        ...
        self._data_rate = Rate.RATE_10_HZ
        ...
        # INT_CTRL_REG
        self._xien = True  # Enables the interrupt detection for the X-axis.
        self._yien = True  # Enables the interrupt detection for the Y-axis.
        self._zien = True  # Enables the interrupt detection for the Z-axis.
        self._int_pol = (
            True  # Controls the polarity of the INT bit when an interrupt occurs.
        )
        self._int_latch = True  # Controls whether the INT bit is latched or pulsed.
        self._int_en = (
            True  # Interrupt enable. When set, enables the interrupt generation.
        )
        self._write_int_ctrl()

        sleep(0.030)  # sleep 30ms to allow measurements to stabilize
    ...
    def offset_x(self, value):
        if value < 0 or value > int(65535 / _MAG_SCALE):
    ...
    def status(self):
        ...
        int_status = self._read_status
        zyxor = int_status & 0b10000000 > 0
        zor = int_status & 0b01000000 > 0
        yor = int_status & 0b00100000 > 0
        xor = int_status & 0b00010000 > 0
        zyxda = int_status & 0b00001000 > 0
        zda = int_status & 0b00000100 > 0
        yda = int_status & 0b00000010 > 0
        xda = int_status & 0b1
    ...
    def magnetic(self):
        ...
        # self._mags = [x*_MAG_SCALE for x in self._mags]
        return (
    ...
    def temperature(self):
        ...
        self._temp = self._temp[0] * 0.0078125
        return self._temp
...
class LIS2MDL_I2C(Adafruit_LIS2MDL):
    ...
    **Quickstart: Importing and using the LIS2MDL**
        ...
        .. code-block:: python
            ...
            lis2mdl = adafruit_lis2mdl.LIS2MDL_I2C(i2c)
...
class LIS2MDL_SPI(Adafruit_LIS2MDL):
    ...
    **Quickstart: Importing and using the LIS2MDL**
        ...
        .. code-block:: python
            ...
            spi = board.SPI()
            lis2mdl = adafruit_lis2mdl.Adafruit_lis2mdl_SPI(spi, cs)
